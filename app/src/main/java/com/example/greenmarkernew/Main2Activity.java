...
import com.example.greenmarkernew.Model.Users;
import com.example.greenmarkernew.Prevalent.Prevalent;
                ...
                if (dataSnapshot.child(parentDbName).child(phone).exists())
                {
                    ...
                    if (usersData.getPhone().equals(phone))
                    {
                        if (usersData.getPassword().equals(password))
                        {
                            ...
                            {
                                Toast.makeText(Main2Activity.this, "Welcome Admin, you are logged in Successfully...", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();

                                Intent intent = new Intent(Main2Activity.this, AdminAddNewProductActivity.class);
